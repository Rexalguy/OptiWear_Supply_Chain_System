...
class SegmentationBarChart extends ChartWidget
{
    ...
    /**
     * The description for the widget, displayed in the Filament admin panel.
     * This can be set to provide additional context or information about the widget's purpose.
     */
