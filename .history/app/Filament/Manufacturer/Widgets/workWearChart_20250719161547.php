...
class workWearChart extends ChartWidget
{
    protected static ?string $heading = 'Work Wear Demand Forecast';

    protected static ?string $description = 'Predicted Demand in Units for Formal Wear over time and seasons';
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label' => 'Work Wear Predicted Quantity',
                    'data' => $data,
