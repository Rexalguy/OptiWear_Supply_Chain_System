...
class segmentationSummary extends BaseWidget
{
    ...
    {
        // Use a simpler approach - create temporary records
        $models = collect([
        ...
        // Return a query that will return these models
        return SegmentationResult::query()->whereIn('id', [1, 2, 3, 4, 5, 6])
            ->when($models->isNotEmpty(), function ($query) use ($models) {
                // This is a hack to make the query return our custom models
