...
{
    protected static ?string $heading = '🏆 Top Product Categories by Customer Segment';
    
    protected static ?string $description = 'Most popular product category for each customer segment based on total units purchased';
