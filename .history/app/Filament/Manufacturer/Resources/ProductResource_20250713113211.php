        ...
        return $table
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image')
                    ->label('Product Image')
                    ->url(fn(Product $record) => $record->image ? asset('storage/' . $record->image) : asset('images/default-product.png')) // Default image if none is set
                    ->alt(fn(Product $record) => $record->name)
                    ->height(80)
                    ->width(80), // important!
