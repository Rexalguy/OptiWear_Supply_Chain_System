...

{
    ...
    protected static string $view = 'filament.vendor.pages.product-ultra-simple';
    ...
    public function addToCartJS($productId, $baleSize)
    {
        $baleSize = (int) $baleSize;
        ...
        if ($target_product) {
            ...
            if (isset($this->cart[$target_product->id])) {
                ...
                $this->notify('warning', 'Product already in cart. Quantity updated.');
            } else {
