...

{
    ...
    public function mount()
    {
        ...
        $this->carouselImages = $this->products->pluck('image')->filter()->values()->toArray();
    }
    ...
    {
        if (count($this->carouselImages) === 0) return;
        $this->carouselIndex = ($this->carouselIndex + 1) % count($this->carouselImages);
    }
    public function prevImage()
    {
        if (count($this->carouselImages) === 0) return;
        $this->carouselIndex = ($this->carouselIndex - 1 + count($this->carouselImages)) % count($this->carouselImages);
    }
}