...
class SupplierReport extends Command
{
    ...
    public function handle()
    {
        ...
        Mail::to('josephotai209@ggit mail.com')->send(new SendSupplierReport($supplier, $pendingOrdersCount, $deliveredOrdersCount, $confirmedOrdersCount, $cancelledOrdersCount, $totalOrdersCount, $totalSales, $reportDate));
    }
}