...
class SupplierReport extends Command
{
    ...
    public function handle()
    {
        ...
        Mail::to($supplier)->send(new SendSupplierReport($supplier, $pendingOrdersCount, $deliveredOrdersCount, $confirmedOrdersCount, $cancelledOrdersCount, $totalOrdersCount, $totalSales, $reportDate));
    }
}