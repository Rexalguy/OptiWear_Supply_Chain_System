...
class SupplierReport extends Command
{
    ...
    public function handle()
    {
        ...
        Mail::to('aburekemmanuel@gmail.com')->send(new SendSupplierReport($supplier, $pendingOrdersCount, $deliveredOrdersCount, $confirmedOrdersCount, $cancelledOrdersCount, $totalOrdersCount, $totalSales, $reportDate));
    }
}