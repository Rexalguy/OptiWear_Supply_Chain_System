...
#show some rows to see if the dataset is loaded correctly
print(df.head())
...
df['DayOfWeek'] = df['Date'].dt.dayofweek  # 0 is Monday, 6 is Sunday
...
#bar graph for comparison of actual vs predicted
