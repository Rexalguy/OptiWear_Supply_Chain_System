...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.executeExport = function () {
            ...
            // Use the simple exporter if available
            if (window.SimpleChartExporter) {
                console.log('Using Simple Chart Exporter');
                document.getElementById('export-status').classList.remove('hidden');
                
                setTimeout(() => {
                    window.SimpleChartExporter.exportAllCharts().then(() => {
