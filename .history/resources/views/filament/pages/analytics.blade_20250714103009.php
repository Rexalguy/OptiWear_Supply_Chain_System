    ...
    <div style="background: #fff; padding: 2rem; border-radius: 1rem; max-width: 1000px; margin: 2rem auto 0 auto; margin-left: 60px;">
        ...
        <script>
            var pieOptions = {
                ...
                stroke: { show: true, width: 6, colors: ['#fff'] }, // Thicker divisions
                fill: { type: 'gradient' },
                tooltip: {
                ...
                plotOptions: {
                    pie: {
                        ...
                        expandOnClick: true,
                        customScale: 1.08 // Slightly increase the scale of each slice
                    }
                },
                dropShadow: {
                    enabled: true,
