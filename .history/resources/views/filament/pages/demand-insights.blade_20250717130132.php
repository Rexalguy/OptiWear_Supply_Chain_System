...
<x-filament-panels::page>
    <div class="max-w-7xl mx-auto">
        <!-- Stats Overview Widgets will be displayed here by the DemandInsights page class -->
        @php
        ...
        <div class="mt-8">
            ...
            <table class="min-w-full bg-transparent divide-y divide-gray-200 dark:divide-gray-700 mb-8">
                <thead>
                    <tr>
                        <th class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">
                            Category</th>
                        <th class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">Total
                            Predicted Demand</th>
                        <th class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">Share
                            (%)</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table class="min-w-full bg-transparent divide-y divide-gray-200 dark:divide-gray-700 mb-8">
                <thead>
                    <tr>
                        <th class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">
                            Category</th>
                        <th class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">Trend
                        </th>
                        <th class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">%
