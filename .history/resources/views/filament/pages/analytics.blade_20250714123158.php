...
<x-filament-panels::page>
    <div
        style="background: #fff; padding: 2rem; border-radius: 1rem; max-width: 1000px; margin: 0 auto; margin-left: 60px; position: relative;">
        ...
        <form method="get" style="position: absolute; top: 2rem; right: 2rem; margin-bottom: 0; z-index: 10;">
            ...
            <select name="time_frame" id="time_frame" onchange="this.form.submit()"
                style="padding: 0.5rem 1rem; border-radius: 0.5rem; border: 1px solid #ccc; min-width: 180px;">
        ...
        <script>
            ...
            var pieOptions = {
                ...
                dataLabels: {
                    enabled: true,
                    style: { fontSize: '13px', fontWeight: 600 }, // Reduced font size
                ...
                stroke: { show: true, width: 3, colors: ['#fff'] }, // Reduced stroke width for less spacing
                fill: { type: 'gradient' },
                tooltip: {
        ...
        <div style="margin-top: 2rem; background: #f9fafb; border-radius: 0.75rem; padding: 1.5rem; max-width: 900px;">
            ...
            @endphp
            <table
                style="width:100%; background: #fff; border-radius: 0.5rem; overflow: hidden; border-collapse: collapse;">
                <thead>
                    ...
                    @foreach($categoryTotals as $row)
                        <tr>
                            ...
                            <td style="padding: 0.5rem 1rem; text-align: right;">
                                {{ $grandTotal > 0 ? number_format(($row['total'] / $grandTotal) * 100, 1) : '0.0' }}%</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            @endphp
            <table
                style="width:100%; background: #fff; border-radius: 0.5rem; overflow: hidden; border-collapse: collapse; margin-bottom: 1.5rem;">
                <thead>
                    <tr style="background: #f3f4f6;">
                        <th style="padding: 0.5rem 1rem; text-align: left;">Category</th>
                ...
                <tbody>
                    ...
                    <tr style="font-weight: bold; background: #f9fafb;">
                        ...
                        <td style="padding: 0.5rem 1rem; text-align: right;">
                            {{ $totalPct !== null ? number_format($totalPct, 1) : '-' }}%</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div
        style="background: #fff; padding: 2rem; border-radius: 1rem; max-width: 1000px; margin: 2rem auto 0 auto; margin-left: 60px;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: flex-start;">
            ...
            <div style="flex: 2 1 400px; min-width: 320px;">
                ...
                <table
                    style="width:100%; background: #f9fafb; border-radius: 0.5rem; overflow: hidden; border-collapse: collapse;">
                    <thead>
                        <tr style="background: #f3f4f6;">
