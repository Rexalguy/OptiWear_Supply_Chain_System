                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <div class="text-xs text-green-600 dark:text-green-400 mt-1">+{{ $growthRate }}% increase
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <form method="get" class="mb-0">
                        <label for="time_frame" class="font-semibold mr-2 text-gray-800 dark:text-gray-200">Time
                            Frame:</label>
                        <select name="time_frame" id="time_frame" onchange="this.form.submit()"
                            ...
                            @foreach($timeFrames as $key => $label)
                                <option value="{{ $key }}" @if($selectedTimeFrame == $key) selected @endif>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                    </form>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ number_format($max['total'] ?? 0) }}
                            units</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ number_format($min['total'] ?? 0) }}
                            units</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        <h4 class="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-2">Total Demand</h4>
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ number_format($grandTotal) }}
                        </p>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-transparent divide-y divide-gray-200 dark:divide-gray-700 mb-8">
                        <thead>
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">
                                    Category</th>
                                <th
                                    class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">
                                    Total Predicted Demand</th>
                                <th
                                    class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">
                                    Share (%)</th>
                            </tr>
                        ...
                        <tbody>
                            @foreach($trendRows as $row)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                                    ...
                                    <td class="px-6 py-3 text-right text-gray-900 dark:text-gray-100">{{ $row['pct'] }}%
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
