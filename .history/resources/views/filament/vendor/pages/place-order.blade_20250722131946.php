...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div class="flex gap-6 p-4  bg-gray-600 rounded-lg mb-4 shadow-sm">
            ...
            <div class="flex-1">
                {{-- Product image --}}
                <div class="w-auto h-100 flex items-center justify-center bg-gray-100 rounded-md mb-3 overflow-hidden">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="w-auto h-32 object-cover rounded">
                </div>
