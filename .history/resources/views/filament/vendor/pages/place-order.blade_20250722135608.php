...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div style="border: 1px solid rgba(37, 37, 37, 0) 0px 0px 0px 1px !important; background: linear-gradient(to bottom, rgba(54, 53, 53, 0) 0%, rgba(54, 53, 53, 0) 100%) !important;" class="flex gap-6 p-4  rounded-lg mb-4 shadow-sm">
