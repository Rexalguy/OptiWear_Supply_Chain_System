    ...
    @if ($selectedProduct && $clickedProduct)
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-6 overflow-y-auto" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-[2rem] p-6 w-full max-w-4xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-0 items-stretch min-h-[500px]">
                    <!-- Product image section - Left side -->
                    <div class="lg:col-span-2 relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-l-[2rem] lg:rounded-r-none rounded-r-[2rem] overflow-hidden flex items-center justify-center p-2">
                        <div class="absolute inset-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm"></div>
                        <div class="relative z-10 w-full h-full flex items-center justify-center">
                            <div class="w-80 h-80 rounded-[1.2rem] overflow-hidden drop-shadow-xl border-2 border-white/30 bg-white">
                                <img src="{{ asset($clickedProduct->image)}}" alt="{{ $clickedProduct->name }}" class="w-80 h-80 object-cover object-center rounded-[1.2rem]" style="width: 320px !important; height: 320px !important;">
                            </div>
                        </div>
                        <!-- Decorative elements -->
                    ...
                    <div class="lg:col-span-3 p-6 space-y-5 flex flex-col justify-center">
                        <div>
