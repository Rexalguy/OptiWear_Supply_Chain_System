...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div class="flex gap-6 p-4  bg-gray-600 rounded-lg mb-4 shadow-sm">
            ...
            <div class="flex-1">
                {{-- Product image --}}
                <div class="w-32 h-32 flex items-center justify-center bg-gray-100 rounded-md mb-3 overflow-hidden">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="w-50 h-32 object-cover rounded">
                </div>
