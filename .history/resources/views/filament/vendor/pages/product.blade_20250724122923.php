        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-4 overflow-y-auto pt-16" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-[2rem] p-8 w-full max-w-2xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 space-y-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-[1rem] p-4">
                    ...
                    <div class="flex gap-4 pt-4">
                        <x-filament::button 
                            ...
                            color="gray" 
                            size="md"
                            class="flex-1 justify-center py-3 px-6 rounded-[1rem] font-semibold transition-all duration-300 hover:scale-105"
                        >
                            Close
                        </x-filament::button>
                        ...
                        <x-filament::button 
                            ...
                            icon="heroicon-m-plus" 
                            icon-position="after"
                            class="flex-1 justify-center py-3 px-6 rounded-[1rem] bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-lg hover:shadow-xl font-semibold transition-all duration-300 hover:scale-105"
                        >
                            Add to Cart
                        </x-filament::button>
                    </div>
                ...
                <div class="absolute top-0 left-0 w-24 h-24 bg-gradient-to-br from-blue-500/10 to-transparent rounded-br-[2rem]"></div>
                <div class="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-purple-500/10 to-transparent rounded-tl-[2rem]"></div>
            </div>
        </div>
    @endif
</div>
