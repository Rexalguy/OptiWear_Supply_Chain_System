        ...
        >
            ...
            <div>
                <div>
                    ...
                    <x-filament::select wire:model="bale_size" id="id">
                        <option value="">Select a Bale size</option>
                        <option value="150">Starter Package: 150 pieces</option>
                        <option value="150">Classic Package: 150 pieces</option>
                        <option value="150">Premium Package: 150 pieces</option>
                    </x-filament::select>
                </div>
                <div>
