    ...
    <div class="rounded border-gray-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        ...
        >
            ...
            <div wire:click="openProductModal({{ $product->id }})" class="relative z-10 w-full h-64 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-t-3xl mb-4 overflow-hidden group-hover:scale-105 transition-transform duration-300">
                ...
                <div class="relative z-10 w-56 h-56 rounded-2xl overflow-hidden drop-shadow-lg group-hover:scale-110 transition-transform duration-300 border-2 border-white/20 bg-white">
                    <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="w-56 h-56 object-cover object-center rounded-2xl" style="width: 224px !important; height: 224px !important;">
                </div>
                <!-- Hover effect overlay -->
                <div class="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
            </div>
