                    ...
                    <div class="w-3/5 p-10 space-y-8 flex flex-col justify-center bg-gradient-to-b from-white/50 to-gray-50/50 dark:from-gray-900/50 dark:to-gray-800/50 backdrop-blur-sm">
                        ...
                        <div class="flex gap-6 pt-6">
                            <x-filament::button 
                                ...
                                color="gray" 
                                size="xl"
                                class="flex-1 justify-center py-6 px-10 rounded-[1.5rem] font-bold transition-all duration-300 hover:scale-105 text-xl bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 border-2 border-gray-300/50 dark:border-gray-600/50 backdrop-blur-sm shadow-xl hover:shadow-2xl premium-glow"
                            >
                                Close
                            </x-filament::button>
                            ...
                            <x-filament::button 
                                ...
                                icon="heroicon-m-plus" 
                                icon-position="after"
                                class="flex-1 justify-center py-6 px-10 rounded-[1.5rem] bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 hover:from-orange-600 hover:via-amber-600 hover:to-yellow-600 text-white shadow-xl hover:shadow-2xl font-bold transition-all duration-300 hover:scale-105 text-xl border-2 border-orange-400/50 backdrop-blur-sm premium-glow shimmer"
                            >
                                Add to Cart
                            </x-filament::button>
                        </div>
