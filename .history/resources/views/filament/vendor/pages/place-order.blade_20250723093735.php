                ...
                <div style="margin-top: 5px !important;" class="mt-4">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="radio" name="delivery_option_{{ $item['id'] }}" value="standard" class="mr-2" wire:click="updateDeliveryOption({{ $item['id'] }}, 'standard')"> 
                            <span>Standard Delivery (3-5 days) : UGX 3000</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="delivery_option_{{ $item['id'] }}" value="express" class="mr-2" wire:click="updateDeliveryOption({{ $item['id'] }}, 'express')"> 
                            <span>Express Delivery (1 day) : UGX 5000</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="delivery_option_{{ $item['id'] }}" value="pickup" class="mr-2" wire:click="updateDeliveryOption({{ $item['id'] }}, 'pickup')"> 
