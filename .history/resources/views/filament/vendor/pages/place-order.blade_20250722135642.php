...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div style="border: 1px solid rgba(65, 60, 60, 0) 0px 0px 0px 1px !important; background: linear-gradient(to bottom, rgba(54, 53, 53, 0) 0%, rgba(54, 53, 53, 0) 100%) !important;" class="flex gap-6 p-4  rounded-lg mb-4 shadow-sm">
            ...
            <div class="w-80 bg-gray-50 p-4 rounded-lg">
                ...
                @if(isset($item['packages']['standard']) && $item['packages']['standard'] > 0)
                    <div class="mb-2">
                        <p class="text-sm text-gray-600">Classic Packages: {{ $item['packages']['standard'] }}</p>
                    </div>
                @endif
