...
<div>
    ...
    @forelse ($cart as $item)
        <div class="grid grid-cols-1 rounded-xl p-4 shadow bg-white dark:bg-gray-900 md:grid-cols-2  items-center justify-between mb-4">
            <div>
                <div class="">
                <div class="w-full h-auto max-h-40 flex items-center justify-center bg-gray-100 rounded-md mb-2 overflow-hidden">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="max-h-full w-auto object-contain">
                </div>
