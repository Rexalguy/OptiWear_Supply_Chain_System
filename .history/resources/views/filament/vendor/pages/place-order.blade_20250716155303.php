    ...
    @forelse ($cart as $item)
        <div class="grid grid-cols-1 md:grid-cols-2  items-center justify-between p-4 ">
            ...
            <div class="flex flex-col gap-4 items-center align-top mt-0">
                ...
                <div class="flex space-x-2 gap-3">
                    <x-filament::button wire:click="reduceQuantity({{ $item->id , 100 }})" color="danger" size="xs" icon="heroicon-m-minus" icon-position="before">350</x-filament::button>
                    <x-filament::button color="success" size="xs" icon="heroicon-m-plus" icon-position="before">350</x-filament::button>
                </div>
                <div class="flex space-x-2 gap-3">
                    <x-filament::button wire:click="reduceQuantity({{ $item->id , 350 }})" color="danger" size="xs" icon="heroicon-m-minus" icon-position="before">750</x-filament::button>
