                ...
                <div style="margin-top: 5px !important;" class="mt-4">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="radio" name="delivery_option_{{ $item['id'] }}" value="delivery" class="mr-2" wire:click="updateDeliveryOption({{ $item['id'] }}, 'delivery')" {{ (isset($delivery_options[$item['id']]) && $delivery_options[$item['id']] === 'delivery') ? 'checked' : '' }}> 
