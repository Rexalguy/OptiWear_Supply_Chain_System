...
<div>
    <x-filament::button color="primary" size="xs" icon="heroicon-m-plus" icon-position="before">
        Label
    </x-filament::button color="info" size="x-lg" weight="Semibold">
       <H1 class="text-lg font-semibold p-2">Cart ({{ $cartCount }})</H1>
    </x-filament::butt<x-filament::button color="primary" size="xs" icon="heroicon-m-plus" icon-position="before">
        Label
    </x-filament::button>
