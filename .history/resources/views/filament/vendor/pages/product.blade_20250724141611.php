...
<div>
    ...
    <div class="rounded border-gray-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        ...
        <div 
            class="group relative rounded-[3rem] p-0 cursor-pointer shadow-lg hover:shadow-2xl bg-white dark:bg-gray-800 transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700 overflow-hidden" 
            style="border-radius: 3rem !important;"
        >
            <!-- Subtle gradient overlay -->
            <div class="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-purple-50/30 dark:from-gray-800/50 dark:to-gray-900/50 rounded-[3rem]" style="border-radius: 3rem !important;"></div>
            
            <!-- Product image with enhanced styling -->
            <div wire:click="openProductModal({{ $product->id }})" class="relative z-10 w-full h-64 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-t-[3rem] mb-4 overflow-hidden group-hover:scale-105 transition-transform duration-300 pt-4" style="border-top-left-radius: 3rem !important; border-top-right-radius: 3rem !important;">
                <div class="absolute inset-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-t-[3rem]" style="border-top-left-radius: 3rem !important; border-top-right-radius: 3rem !important;"></div>
                <div class="relative z-10 w-56 h-56 rounded-[2rem] overflow-hidden drop-shadow-lg group-hover:scale-110 transition-transform duration-300 bg-white border-2 border-white/30" style="border-radius: 2rem !important;">
                    <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="w-56 h-56 object-cover object-center rounded-[2rem]" style="width: 224px !important; height: 224px !important; border-radius: 2rem !important;">
                </div>
                <!-- Hover effect overlay -->
                <div class="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-t-[3rem]" style="border-top-left-radius: 3rem !important; border-top-right-radius: 3rem !important;"></div>
            </div>
            ...
            <div class="relative z-10 px-4 pb-4">
                <div class="mb-4">
                    ...
                    <select wire:model="bale_size.{{ $product->id }}" class="w-full mt-3 px-4 py-3 rounded-[1.5rem] border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all duration-300 font-medium" style="border-radius: 1.5rem !important;">
                ...
                <div class="pt-2">
                    <x-filament::button 
                        ...
                        icon-position="after"
                        class="w-full justify-center font-semibold py-3 px-6 rounded-[1.5rem] bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                    >
                        Add to Cart
                    </x-filament::button>
                </div>
            ...
            <div class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-bl-[3rem]"></div>
        </div>
        @endforeach
    </div>
            ...
            <div class="relative shadow-2xl bg-white dark:bg-gray-900 rounded-[3rem] p-0 w-full max-w-6xl modal-slide-up my-8 mx-auto overflow-hidden backdrop-blur-sm" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 flex gap-8 h-[650px]">
                    ...
                    <div class="flex-1 p-10 pr-16 space-y-8 flex flex-col justify-center bg-gradient-to-b from-white/50 to-gray-50/50 dark:from-gray-900/50 dark:to-gray-800/50 backdrop-blur-sm rounded-r-[3rem]">
                        ...
                        <div class="bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-800/80 dark:to-gray-700/80 rounded-[2.5rem] p-8 backdrop-blur-sm shadow-xl premium-glow">
                            ...
                            <select wire:model="bale_size.{{ $clickedProduct->id }}" class="w-full px-4 py-3 rounded-[1.5rem] border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all duration-300 font-medium">
                                <option value="" class="text-gray-500">🎯 Select Package Size</option>
                                <option value="100" class="font-medium">🚀 Starter: 100 pieces</option>
                                <option value="350" class="font-medium">⭐ Classic: 350 pieces</option>
                                <option value="750" class="font-medium">💎 Premium: 750 pieces</option>
                        ...
                        <div class="flex justify-between pt-6">
                            <x-filament::button 
                                ...
                                color="gray" 
                                size="xl"
                                class="justify-center py-6 px-12 rounded-[2rem] font-bold transition-all duration-300 hover:scale-105 text-xl bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 backdrop-blur-sm shadow-xl hover:shadow-2xl premium-glow"
                            >
                                Close
                            </x-filament::button>
