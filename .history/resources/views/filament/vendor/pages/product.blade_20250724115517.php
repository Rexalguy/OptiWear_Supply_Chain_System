        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-4 overflow-y-auto pt-16" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-2xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 w-full h-80 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl mb-6 overflow-hidden">
                    ...
                    <div class="relative z-10 w-72 h-72 rounded-lg overflow-hidden drop-shadow-xl border-2 border-white/30 flex items-center justify-center bg-white">
                        <img src="{{ asset($clickedProduct->image)}}" alt="{{ $clickedProduct->name }}" class="w-full h-full object-cover">
                    </div>
                    <!-- Decorative elements -->
