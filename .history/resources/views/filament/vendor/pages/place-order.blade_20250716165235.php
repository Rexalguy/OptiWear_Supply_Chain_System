...
<div>
    ...
    @forelse ($cart as $item)
        <div class="grid grid-cols-1 rounded-xl p-4 shadow bg-white dark:bg-gray-1000 md:grid-cols-2  items-center justify-between mb-4">
            <div class="">
                ...
                <div class="flex gap-4 items-center align-top mt-0">
                    ...
                    <div class="flex flex-col gap-4 items-center align-top mt-0">
                        <div class="flex flex-col space-x-2 gap-3">
                            <x-filament::button color="danger" size="x-lg" >Remove Item</x-filament::button>
                            <x-filament::button color="success" size="x-lg">Place Order</x-filament::button>
                        </div>
                    </div>
                </div>
            </div>
