    ...
    @if ($selectedProduct && $clickedProduct)
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-4 overflow-y-auto pt-16" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-2xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 w-full h-72 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl mb-6 overflow-hidden">
                    <div class="absolute inset-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm"></div>
                    <div class="relative z-10 h-64 w-64 rounded-lg overflow-hidden drop-shadow-xl">
                        <img src="{{ asset($clickedProduct->image)}}" alt="{{ $clickedProduct->name }}" class="h-full w-full object-cover">
                    </div>
                    <!-- Decorative elements -->
