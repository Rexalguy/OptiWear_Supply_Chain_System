...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div class="flex gap-6 p-4  bg-gray-600 rounded-lg mb-4 shadow-sm">
            {{-- Left side: Product details and controls --}}
            <div class="flex-1">
                {{-- Product image --}}
                <div class="w-48 h-48 flex items-center justify-center bg-gray-100 rounded-md mb-3 overflow-hidden flex-shrink-0">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="w-48 h-48 object-cover rounded">
                </div>
