...
<div>
    ...
    <div class="rounded border-gray-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        ...
        >
            ...
            <div wire:click="openProductModal({{ $product->id }})" class="relative z-10 w-full h-56 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl mb-4 overflow-hidden group-hover:scale-105 transition-transform duration-300">
                <div class="absolute inset-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"></div>
                <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="relative z-10 h-48 w-48 object-cover rounded-lg drop-shadow-lg group-hover:scale-110 transition-transform duration-300">
    ...
    @if ($selectedProduct && $clickedProduct)
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-4 overflow-y-auto pt-16" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-2xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 w-full h-64 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl mb-6 overflow-hidden">
                    <div class="absolute inset-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm"></div>
                    <img src="{{ asset($clickedProduct->image)}}" alt="{{ $clickedProduct->name }}" class="relative z-10 max-w-full max-h-full object-contain drop-shadow-xl">
                    <!-- Decorative elements -->
