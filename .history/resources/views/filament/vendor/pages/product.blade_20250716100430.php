        ...
        >
            ...
            <div>
                <div>
                    ...
                    <select wire:model="bale_size" style="background: #fff; color: #222; border: 1px solid #ccc;" class="form-select rounded-md shadow-sm my-2">
                    ...
                    <select wire:model="bale_size" class="form-select rounded-md shadow-sm my-2">
                        <option value="" >Select a Bale size</option>
                        <option value="100">Starter Package: 100 pieces</option>
                        <option value="350">Classic Package: 350 pieces</option>
                        <option value="750">Premium Package: 750 pieces</option>
