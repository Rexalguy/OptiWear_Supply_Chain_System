...
<div>
    ...
    @if ($selectedProduct && $clickedProduct)
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm modal-fade-in p-4 overflow-y-auto pt-16" style="cursor:pointer;" wire:click.self="closeProductModal">
            <div class="relative shadow-2xl bg-white dark:bg-gray-800 rounded-[2rem] p-8 w-full max-w-2xl modal-slide-up my-8 mx-auto border border-gray-200 dark:border-gray-700" style="cursor:auto;" @click.stop>
                ...
                <div class="relative z-10 w-full h-96 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-[2rem] mb-6 overflow-hidden">
                    <div class="absolute inset-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-[2rem]"></div>
                    <div class="relative z-10 w-80 h-80 rounded-[1.5rem] overflow-hidden drop-shadow-xl border-2 border-white/30 bg-white">
                        <img src="{{ asset($clickedProduct->image)}}" alt="{{ $clickedProduct->name }}" class="w-80 h-80 object-cover object-center rounded-[1.5rem]" style="width: 320px !important; height: 320px !important;">
                    </div>
                    <!-- Decorative elements -->
