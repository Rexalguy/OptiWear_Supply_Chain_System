...
<div>
    ...
    @forelse ($cart as $item)
        ...
        <div class="flex gap-6 p-4  bg-gray-500 rounded-lg mb-4 shadow-sm">
            {{-- Left side: Product details and controls --}}
            <div class="flex-1">
                {{-- Product image --}}
                <div class="w-48 h-48 flex items-start justify-center rounded-md mb-3 overflow-hidden flex-shrink-0">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="w-auto h-auto object-cover rounded max-w-none min-w-auto min-h-0" style="width: 192px !important; height: 192px !important;">
                </div>
