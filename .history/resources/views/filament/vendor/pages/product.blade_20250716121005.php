...
<div>
    <div class="flex justify-end">
        <a href="{{ url('/vendor/place-order') }}">
            <x-filament::button color="warning" size="x-lg" weight="Semibold" iconheroicon-o-shopping-cart>
                <x-filament::icon name="heroicon-o-shopping-cart" class="h-6 w-6" />
