            ...
            <div class="relative z-10 px-4 pb-4">
                <div class="mb-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <p ><span class="text-lg font-bold text-green-600 dark:text-green-400">UGX{{ number_format($product->unit_price) }}</span><span class="text-lg font-bold text-grey-600 dark:text-grey-400">UGX{{ number_format( $product->unit_price - ($product->unit_price * 0.05)) }}</span></p>
                    </div>
