...
(function () {
    ...
    // Also create the executeExport function for the modal
    window.executeExport = function () {
        console.log('executeExport called from modal');
        return UniversalChartExporter.exportAllCharts();
    };

    console.log('Universal Chart Exporter loaded. Use: exportChartsNow() or executeExport()');
