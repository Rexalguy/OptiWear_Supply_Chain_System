...
<x-filament-panels::page>
                        ...
                        <div class="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-800 rounded">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="w-20 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                    <div class="bg-blue-500 h-2 rounded-full" style="width: {{ $stat['percentage'] }}%">
                                    </div>
                                </div>
                                <span
                                    class="text-sm text-gray-600 dark:text-gray-400 w-12">{{ $stat['percentage'] }}%</span>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow p-8 max-w-6xl mx-auto mb-8">
        ...
        <table class="min-w-full bg-transparent divide-y divide-gray-200 dark:divide-gray-700">
            <thead>
                <tr>
                    <th class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">Segment
                    </th>
                    <th class="px-6 py-3 text-left text-base font-semibold text-gray-700 dark:text-gray-200">Most
                        Popular Category</th>
                    <th class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">Total
                        Purchased</th>
                    <th class="px-6 py-3 text-right text-base font-semibold text-gray-700 dark:text-gray-200">Market
                        Share</th>
                </tr>
            </thead>
                ...
                @foreach($segmentTopBuys as $index => $row)
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="w-3 h-3 rounded-full mr-3"
                                    style="background-color: {{ ['#6366f1', '#f59e42', '#10b981', '#ef4444', '#fbbf24', '#3b82f6', '#a21caf', '#14b8a6'][$index % 8] }}">
                                </div>
                        ...
                        <td class="px-6 py-4 text-right text-gray-900 dark:text-gray-100 font-semibold">
                            {{ number_format($row->total_purchased) }}</td>
